...
const Footer: React.FC = () => {
  return (
    <footer className="bg-slate-950 text-slate-300 py-12 lg:py-16 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6 text-center sm:text-left">
            ...
            <p className="text-slate-400 leading-relaxed font-light mx-auto sm:mx-0 max-w-sm">
            ...
            <div className="flex justify-center sm:justify-start space-x-4">
              <a href="#" className="p-2 bg-white/5 rounded-full hover:text-amber-400 transition-colors"><Facebook size={20} /></a>
              <a href="#" className="p-2 bg-white/5 rounded-full hover:text-amber-400 transition-colors"><Instagram size={20} /></a>
              <a href="#" className="p-2 bg-white/5 rounded-full hover:text-amber-400 transition-colors"><Twitter size={20} /></a>
            </div>
          </div>
          ...
          <div className="space-y-6 text-center sm:text-left">
            ...
            <div className="space-y-4">
              <div className="flex items-start justify-center sm:justify-start space-x-3">
                <MapPin className="text-amber-400 mt-1 shrink-0" size={18} />
                <span className="max-w-[200px] sm:max-w-none">123 Ocean Drive, Miami Beach, FL 33139</span>
              </div>
              ...
              <div className="flex items-center justify-center sm:justify-start space-x-3">
                ...
                <span className="truncate">info@grandhorizon.com</span>
              </div>
            </div>
          </div>
        </div>

        <div className="mt-16 pt-8 border-t border-slate-900 flex flex-col md:flex-row justify-between items-center text-sm font-light text-center md:text-left">
