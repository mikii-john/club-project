...
import { LogOut, LayoutDashboard, Home, ShieldCheck, BedDouble, Sun, Moon, Menu, X, Key } from 'lucide-react';
              ...
              <>
                <div className="hidden lg:flex items-center space-x-4">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <Link
                      to="/change-password"
                      className={`flex items-center gap-2 px-3 py-2 text-sm font-medium rounded-full transition-all ${isActive('/change-password') ? 'text-slate-900 bg-slate-100 dark:text-white dark:bg-slate-800' : 'text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white hover:bg-slate-50 dark:hover:bg-slate-800'}`}
                    >
          ...
          <div className="px-4 pt-2 pb-6 space-y-2">
            ...
            <div className="pt-4 border-t border-gray-100 dark:border-slate-800">
              ...
              <Link
                to="/change-password"
                onClick={() => setIsMenuOpen(false)}
                className={`w-full flex items-center gap-3 px-4 py-3 text-base font-medium rounded-xl transition-all ${isActive('/change-password') ? 'text-slate-900 bg-slate-100 dark:text-white dark:bg-slate-800' : 'text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white hover:bg-slate-50 dark:hover:bg-slate-800'}`}
              >
